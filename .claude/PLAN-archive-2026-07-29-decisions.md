# PLAN archive — 2026-07-29 slim (closed-finding Binding decisions + Progress entries)

> Moved verbatim from PLAN.md on 2026-07-29 when the plan was slimmed after the
> F21/F45 closures and the F22 evidence campaign. These entries remain binding
> history; the live PLAN keeps only decisions that still steer OPEN work.
> Earlier archives: `.claude/PLAN-archive-2026-07-20-phases0-9.md`,
> `.claude/PLAN-archive-2026-07-27-r0-f20.md`.

## Binding decisions (moved)
