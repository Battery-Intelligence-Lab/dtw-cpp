...
- Webb, G. I. & Petitjean, F. (2021). Tight lower bounds for Dynamic Time Warping (LB_Petitjean, LB_Webb). *Pattern Recognition*, 115, 107895. DOI `10.1016/j.patcog.2021.107895`; accepted preprint arXiv:2102.07076 (https://arxiv.org/pdf/2102.07076). **[confirmed 2026-07-30 from the journal record and complete preprint]** Theorem 2 gives the four-point correction condition and Algorithm 2 defines full LB_Webb with `MinLRPaths`; the later `LB_Webb_NoLR` formula applies the bridge and corrections over all indices. The paper proves LB_Webb always at least LB_Keogh. Its Wafer table reports NoLR tightness 0.96904 versus full Webb 0.96891, so omitting `MinLRPaths` does not have a universal loosening direction.
