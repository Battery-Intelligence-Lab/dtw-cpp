...
4. Code your solution. Please do not forget to read the [coding conventions](conventions.md)!
...
The core team will review your PR as soon as possible. If accepted, we will add you to the [list of contributors](contributors.md).
