...
- [ ] **M13** `dtwc/api.cpp:316` — Tier-1 C++ `pam` hardcodes seed 29; Python Tier-1 uses unseeded `fast_pam`; sklearn defaults to 42. Unify the cross-language Tier-1 default seed story (contract addendum + test on a NON-well-separated fixture that would expose divergence).
