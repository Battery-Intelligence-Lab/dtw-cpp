...
- [ ] **L7** Re-record the Python floor with a committed run-log (claimed 409 passed, measured 407 — find the 2-test delta or correct the floor); re-record the skip-count story (6 skips llfio-ON vs 8 claimed llfio-OFF) so the next gate has one unambiguous floor per configuration.
