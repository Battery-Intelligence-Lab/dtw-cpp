...
- [ ] **M7** `one_batch_pam.cpp:110-135` — debias-with-max and NNIW n/m weights are [inferred] from "the reference implementation", not verified against arXiv:2501.19285. Verify against the paper/reference code (research subagent), record CONFIRMED or corrected in a run-log + CITATIONS.md.
