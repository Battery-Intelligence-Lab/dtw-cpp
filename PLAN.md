...
- [ ] **M2** `Result.distance_matrix` now `None` for matrix-free methods (justified change, openly tested at `tests/python/test_api.py:212`) — but absent from CHANGELOG and migration guide. Add both lines.
