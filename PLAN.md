...
- [ ] **M5** Two soft-DTW implementations now coexist (`dtwc/soft_dtw.hpp:224` |x−y| cost vs barycenter's squared-cost rewrite) with no cross-check. Add a cross-implementation consistency test (identical value on shared-cost cases), and record the unification decision for 8.3.
