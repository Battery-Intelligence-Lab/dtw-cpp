/**
 * @file env.hpp
 * @brief Compatibility forwarder — this header moved to dtwc/base/env.hpp.
 *
...
#pragma message("dtwc/env.hpp has moved to dtwc/base/env.hpp. The old path still works in this release and will be removed in the next one; please include \"base/env.hpp\" instead.")
