/**
 * @file timing.hpp
 * @brief Compatibility forwarder — this header moved to dtwc/base/timing.hpp.
 *
...
#pragma message("dtwc/timing.hpp has moved to dtwc/base/timing.hpp. The old path still works in this release and will be removed in the next one; please include \"base/timing.hpp\" instead.")
