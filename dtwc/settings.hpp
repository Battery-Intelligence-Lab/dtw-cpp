/**
 * @file settings.hpp
 * @brief Compatibility forwarder — this header moved to dtwc/base/settings.hpp.
 *
...
#pragma message("dtwc/settings.hpp has moved to dtwc/base/settings.hpp. The old path still works in this release and will be removed in the next one; please include \"base/settings.hpp\" instead.")
