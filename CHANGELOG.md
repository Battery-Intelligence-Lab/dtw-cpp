...
- **LB_Keogh pruning path (Metal)**: opt-in lower-bound prune pipeline mirroring the CUDA envelope/LB/compaction kernels (`dtwc/cuda/cuda_dtw.cu:785-910`). Three new MSL kernels:
